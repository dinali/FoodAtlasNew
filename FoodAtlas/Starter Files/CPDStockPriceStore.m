...
- (NSArray *)dailyPortfolioPrices
{
    ...
    if (!prices)
    {
        prices = [NSArray arrayWithObjects:
                  [NSDecimalNumber numberWithFloat:10.13],
...
- (NSArray *)weeklyMsftPrices
{
    ...
    {
        prices = [NSArray arrayWithObjects:
                  [NSDecimalNumber numberWithFloat:432.12],
                  [NSDecimalNumber numberWithFloat:431.92],
                  [NSDecimalNumber numberWithFloat:432.20],
                  [NSDecimalNumber numberWithFloat:432.11],
