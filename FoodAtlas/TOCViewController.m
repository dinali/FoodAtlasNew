...
// maybe the mainVC is no longer underneath?
...
- (void)insertLayer:(AGSLayer*)layer atIndex:(int)index
{
    ...
    NSLog(@"TOC insertlayerName = %@", string);
    ...
    if (([trimmedString isEqualToString: @"Search Layer"]) ||
        ([trimmedString isEqualToString: @"SNAP Retailers"]) ||
...
//    
//    //self.mapViewLevelLayerInfo = nil;
//    self.mapView = nil;
//    
//    // [self dismissViewControllerAnimated:YES completion:nil];
//    [self.navigationController popViewControllerAnimated:YES]; // does this trigger viewWillAppear in MainVC?? nope, why not?
//    
